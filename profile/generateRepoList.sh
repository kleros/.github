...
ICONS['Proof-Of-Humanity']='src="../assets/poh-logo.svg" width="48"'
ICONS['Proof-Of-Humanity-v2']='src="../assets/poh-logo.svg" width="48"'
...
echo "# Arbitrated"
renderHeaders
for product in Dispute-Resolver Governor Gnosis-Zodiac-Reality-Governor Generalized-Curated-List Token-List Reality Moderate Linguo Escrow Claim-Manager
do
  echo -n "| $(renderIcon $product) **$product**"
  for layer in ${LAYERS[@]}
  do 
